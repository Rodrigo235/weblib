...
public class UsuarioHibernate implements UsuarioDao {
    ...
    public Usuario buscar(long id_usuario) {
        Usuario usuario = null;
            em.getTransaction().begin();
            TypedQuery qc = em.createQuery("from usuario where i_usuario = :id", Usuario.class);
    ...
    public List<Usuario> buscarPorNome(String nome) {
        List<Usuario> usuarios =  null;
        em.getTransaction().begin();
        TypedQuery<Usuario> qc = em.createQuery("from usuario where nome like :%nome%", Usuario.class);
    ...
    public Usuario buscarPorLogin(String login) {
        Usuario usuario =  null;
        em.getTransaction().begin();
        TypedQuery<Usuario> qc = em.createQuery("from usuario where login = :login", Usuario.class);
        qc.setParameter("login", login);
        usuario = (Usuario) qc.getSingleResult();
